...
class robot:
    ...
    def move(self, motion): # Do not change the name of this function
        ...
        steeringAngle = random.gauss(motion[0], self.steering_noise)
        ...
        if abs(turningAngle) < 0.001:
            ...
            turningRadius = distance / turningAngle
    ...
    def sense(self, add_bearing_noise=0): #do not change the name of this function
        Z = []

        for landmark in landmarks:
            bearing = atan2(landmark[0] - self.y, landmark[1] - self.x) - self.orientation
            if add_bearing_noise:
