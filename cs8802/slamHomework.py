...
def doit(initial_pos, move1, move2, Z0, Z1, Z2):
    Omega = matrix([[1.0]]).expand(5, 5, [0], [0])
    Xi    = matrix([[initial_pos]]).expand(5, 1, [0], [0])

    Omega += matrix([[1.0, -1.0], [-1.0, 1.0]]).expand(5, 5, [0, 1], [0,1])
    Xi    += matrix([[-move1], [move1]]).expand(5, 1, [0, 1], [0])
    
    Omega += matrix([[1.0, -1.0], [-1.0, 1.0]]).expand(5, 5, [1, 2], [1,2])
    Xi    += matrix([[-move2], [move2]]).expand(5, 1, [1, 2], [0])
    
    # landmarks
    Omega += matrix([[2.0, -2.0], [-2.0, 2.0]]).expand(5, 5, [0, 3], [0, 3])
    Xi    += matrix([[-2.0 * Z0], [2.0 * Z0]]).expand(5, 1, [0, 3], [0])

    Omega += matrix([[2.0, -2.0], [-2.0, 2.0]]).expand(5, 5, [1, 4], [1, 4])
    Xi    += matrix([[-2.0 * Z1], [2.0 * Z1]]).expand(5, 1, [1, 4], [0])

    Omega += matrix([[2.0, -2.0], [-2.0, 2.0]]).expand(5, 5, [2, 4], [2, 4])
    Xi    += matrix([[-2.0 * Z2], [2.0 * Z2]]).expand(5, 1, [2, 4], [0])
